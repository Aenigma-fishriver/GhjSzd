...
smjq(document).ready(function(){
    ...
    // if(getwidth != null && getheight != null){ // 原来的代码是判断的null，但是很奇怪，明明是空值（或者说我认为是空值，但是却不等于null，所以改成判断true/false
